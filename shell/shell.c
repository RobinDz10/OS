...
const	struct	cmdent	cmdtab[] = {
	{"run", FALSE, xsh_run},				// Add shellcmd "run", according to Assignment 3
	{"prodcons", FALSE, xsh_prodcons},		// Add shellcmd "prodcons", according to Assignment 2
	{"hello",	FALSE,	xsh_hello},			// Add shellcmd "hello", according to Assignment 1
